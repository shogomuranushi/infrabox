...
func init() {
	...
	rootCmd.AddCommand(createCmd, listCmd, deleteCmd, sshCmd, scpCmd, restartCmd, renameCmd, authCmd, initCmd, upgradeCmd, versionCmd, adminCmd, topCmd, setupScriptCmd, syncCmd, storageCmd)
}

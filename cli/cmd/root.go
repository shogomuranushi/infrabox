...
func init() {
	...
	rootCmd.AddCommand(createCmd, listCmd, deleteCmd, sshCmd, sshProxyCmd, scpCmd, restartCmd, renameCmd, authCmd, initCmd, upgradeCmd, versionCmd, adminCmd, topCmd, setupScriptCmd)
}
